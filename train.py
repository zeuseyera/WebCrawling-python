...
def train( args ):
    ...
    # 이전에 저장된 모델에서 계속하는 경우 호환성을 확인한다
    if args.init_from is not None:
        ...
        # 저장된 vocab/dict 를 열고 vocab/dict 가 호환되는지 확인한다
    ...
    # https://translate.googleusercontent.com/translate_c?depth=1&hl=ko&prev=search&rurl=translate.google.co.kr&sl=en&sp=nmt4&u=https://stackoverflow.com/questions/41117740/tensorflow-crashes-with-cublas-status-alloc-failed&usg=ALkJrhiZtdMHHh0mv_kGxyHledpeVrTtvw
    # https://translate.googleusercontent.com/translate_c?depth=1&hl=ko&prev=search&rurl=translate.google.co.kr&sl=en&sp=nmt4&u=https://www.tensorflow.org/tutorials/using_gpu&usg=ALkJrhikpXn8lCSAcVZgMSflj672dD5YfA
    SeolJeong_GPU = tf.ConfigProto()
    SeolJeong_GPU.gpu_options.allow_growth = True
    # 위와 같은 방법 아님.....
    #SeolJeong_GPU = tf.ConfigProto( allow_growth=True )
